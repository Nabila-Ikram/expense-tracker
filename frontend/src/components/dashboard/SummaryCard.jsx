...
const SummaryCard = () => {
  return (
    <div className=' text-white w-[95%] bg-linear-to-r from-[rgba(205,139,186,0.8)] to-[rgba(168,113,211,0.9)] h-[50%] m-3 p-3 border border-fuchsia-300 rounded-sm '>
        ...
        <div className=' h-[10%]  bg-linear-to-r from-gray-700 to-purple-900 rounded-sm flex justify-around items-center'>
            <h1><u>1 Year</u></h1>
            <h1><u>6 Months</u></h1>
            <h1><u>3 Months</u></h1>
            <h1><u>1 Month</u></h1>
        ...
        />
         {/* XAxis displays labels on the horizontal axis.
            ...
            from each object in the data array. */}
               <Tooltip /> // When the user hovers:balnace automatically appears
